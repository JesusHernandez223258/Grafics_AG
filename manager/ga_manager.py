...
4. Consulte manager/README_FOR_NEW_ALGORITHMS.md para la interfaz requerida.
5. Importe su clase de AG en este archivo (ga_manager.py).
6. Registre su AG en el diccionario AVAILABLE_ALGORITHMS abajo,
...
def get_ga_instance(algorithm_name: str):
    ...
    Returns:
        Una instancia de la clase del algoritmo genético.
